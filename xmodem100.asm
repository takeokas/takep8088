...
ld01:	
	...
	LOOP  ld01
	;; jump to loaded obj
	jmp  recv_objseg:recv_objoff ;db 0eah ;jmp far, offset, segment; start=400h{cs=40h,pc=100h}
	;jmp  040h:0h ;db 0eah ;jmp far, offset, segment; start=400h{cs=40h,pc=00h}
	;jmp  040h:100h ;db 0eah ;jmp far, offset, segment; start=400h{cs=40h,pc=100h}
	;; 
;;; 
send_ack:
    mov al, ACK
